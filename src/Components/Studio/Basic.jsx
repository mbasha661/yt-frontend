...
function Basic() {
  const backendURL = "https://yt-backend-5hoe.onrender.com";
  // cconst backendURL = "https://yt-backend-5hoe.onrender.com";
  const [channelName, setChannelName] = useState();
  const [channelDescription, setChannelDescription] = useState();
  const [channelID, setChannelID] = useState("");
  const channelUrl = "https://ytclonebasha.netlify.app/channel";
